import vocab_it
from bert_utils import load_testset_data
...
def test_sentences():
    ...
    for example_data in testset_data['sentences']:
        ...
        sentence_good_extraction_resumption = example_data['sentence_good_extraction_resumption']
        sentence_good_extraction_as_subject = example_data['sentence_good_extraction_as_subject']
