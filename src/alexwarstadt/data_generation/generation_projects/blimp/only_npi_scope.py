...
class Generator(data_generator.BenchmarkGenerator):
    ...
    def sample(self):
        ...
        data = {
            "sentence_good": "Only %s %s %s %s %s %s ever %s."
            % (
                subj[0],
                rel[0],
                args_emb["subj"][0],
            ...
            "sentence_bad": "%s %s only %s %s %s %s ever %s."
            % (
                subj[0],
                rel[0],
                args_emb["subj"][0],
            ...
            "two_prefix_prefix_good": "Only %s %s %s %s %s %s"
            % (
                subj[0],
                rel[0],
                args_emb["subj"][0],
            ...
            "two_prefix_prefix_bad": "%s %s only %s %s %s %s"
            % (
                subj[0],
                rel[0],
                args_emb["subj"][0],
