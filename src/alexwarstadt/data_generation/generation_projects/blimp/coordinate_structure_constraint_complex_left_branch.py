...
class Generator(data_generator.BenchmarkGenerator):
    ...
    def sample(self):
        ...
        N2 = N_to_DP_mutate(
            choice(
                get_matches_of(
                    V_do, "arg_1", get_matches_of(V2_match, "arg_1", all_nouns)
                )
            )
        )
        ...
        data = {
            "sentence_good": "%s %s %s %s %s and %s %s?"
            % (wh[0], N3[0], V_do[0], N1[0], V1[0], N2[0], V2_match[0]),
            "sentence_bad": "%s %s %s %s %s and %s %s?"
            % (wh[0], V_do[0], N1[0], V1[0], N3[0], N2[0], V2_match[0]),
            "two_prefix_prefix_good": "%s %s %s %s %s and"
            % (wh[0], N3[0], V_do[0], N1[0], V1[0]),
            "two_prefix_prefix_bad": "%s %s %s %s %s and"
            % (wh[0], V_do[0], N1[0], V1[0], N3[0]),
