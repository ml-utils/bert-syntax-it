...
class Generator(data_generator.BenchmarkGenerator):
    ...
    def sample(self):
        ...
        data = {
            "sentence_good": "%s %s %s %s %s not ever %s."
            % (
                args["subj"][0],
                rel[0],
                args_emb["aux"][0],
            ...
            "sentence_bad": "%s %s %s not %s %s ever %s."
            % (
                args["subj"][0],
                rel[0],
                args_emb["aux"][0],
            ...
            "two_prefix_prefix_good": "%s %s %s %s %s not"
            % (args["subj"][0], rel[0], args_emb["aux"][0], VP_emb[0], args["aux"][0]),
            "two_prefix_prefix_bad": "%s %s %s not %s %s"
            % (args["subj"][0], rel[0], args_emb["aux"][0], VP_emb[0], args["aux"][0]),
