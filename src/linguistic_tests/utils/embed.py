...
def embed_in_question(sentence):
    ...
    return "{} {} {} whether {}".format(N[0], aux[0], V[0], sentence)
...
def embed_in_conditional(sentence):
    ...
    if random.choice([True, False]):
        return "{} {}, {}.".format(conditional, sentence, consequent)
    else:
        return "{} {} {}.".format(consequent, conditional, sentence)
