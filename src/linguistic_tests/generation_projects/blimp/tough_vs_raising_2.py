...
class Generator(data_generator.BenchmarkGenerator):
    def __init__(self):
        ...
        self.tough_preds = np.setdiff1d(
            get_all("category_2", "Adj_tough"), get_all("expression", "ready")
        )
        self.safe_verbs = np.setdiff1d(
            all_bare_verbs,
    ...
    def sample(self):
        ...
        data = {
            "sentence_good": "{} {} {} to {}.".format(
                subj[0], be[0], A_raising[0], VP[0]
            ),
            "sentence_bad": "{} {} {} to {}.".format(subj[0], be[0], A_tough[0], VP[0]),
        }
