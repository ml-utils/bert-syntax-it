...
class DetNGenerator(data_generator.BenchmarkGenerator):
    ...
    def sample(self):
        ...
        N2_match = choice(
            get_matches_of(V1, "arg_2", self.all_irreg_pluralizable_nouns)
        )
        ...
        data = {
            ...
            % (N1[0], V1[0], Dem[0], adj[0], N2_match[0]),
            "sentence_bad": "%s %s %s %s %s."
            % (N1[0], V1[0], Dem[0], adj[0], N2_mismatch),
            "one_prefix_prefix": "{} {} {} {}".format(N1[0], V1[0], Dem[0], adj[0]),
