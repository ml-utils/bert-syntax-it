...
def main(
    ...
    if len(sys.argv) > 1:
        ...
        # #         }
        # gilberto_model_type_and_name = {
        #     "idb-ita/gilberto-uncased-from-camembert": ModelTypes.GILBERTO,
        # }
        # bertbase_2Btokens_model_type_and_name = {
        #     "dbmdz/bert-base-italian-cased": ModelTypes.BERT,
        # }
        # model_types_and_names: Dict[
        #     str, ModelTypes
        # ] = bertbase_2Btokens_model_type_and_name # MODEL_TYPES_AND_NAMES_IT  # gpt_it_model_type_and_name
        model_types_and_names = {
